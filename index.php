...
<body>
	...
	<div class="homepage-middle-wrapper">
		...
		<div class="container homepage-middle">
			...
			<!-- middle row -->			
				<div class="col-xs-12">
					<div class="h1 underline-title">學校新聞</div>
				</div>
				...
				<div class="col-xs-8">
					<div class="row homepage-image-row">
						<div class="col-xs-12">
							<a href="#"> <img src="images/mainPagePicSmall1.png" alt=""> </a><a href="#"> <img src="images/mainPagePicSmall2.png" alt=""> </a>
						</div>
					</div>
					<div class="row homepage-image-row">
						<div class="col-xs-12">
							<a href="#"> <img src="images/mainPagePicSmall3.png" alt=""> </a><a href="#"> <img src="images/mainPagePicSmall4.png" alt=""> </a>
						</div>
					</div>
				</div>
	...
	<div class="container homepage-bottom">
		...
		<!-- Bottom Page Area-->
			<div class="col-xs-12">		
				<!-- Bottom Page Title -->
				<div class="h1 underline-title underline-title-bottom">學習    -    啟發     -    創作</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-4 text-center">
				<a href="#" class="circle-image-link">
					<img src="images/mainPagePicCircle1.png" alt="">
					<div class="h1">學生故事</div>
				</a>
			</div>
			<div class="col-xs-4 text-center">
				<a href="#" class="circle-image-link">
					<img src="images/mainPagePicCircle2.png" alt="">
					<div class="h1">學校歷史</div>
				</a>
			</div>
			<div class="col-xs-4 text-center">
				<a href="#" class="circle-image-link">
					<img src="images/mainPagePicCircle3.png" alt="">
					<div class="h1">藝術創意</div>
				</a>
			</div>
		</div>
	</div>
